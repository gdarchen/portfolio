  ...
  return (
    <motion.div whileHover={{ y: -3, transition: { duration: 0.1 } }}>
      <a href={href} target="_blank" rel="noreferrer">
        <Icon className="size-6 fill-current text-gray-400 hover:cursor-pointer hover:text-primary" />
      </a>
    </motion.div>
  )
}
      ...
      >
        <div className="flex flex-col items-center justify-center space-y-28">
          ...
          >
            ...
            >
              <span className="font-header tracking-wider text-gray-400 hover:cursor-pointer hover:text-primary">
